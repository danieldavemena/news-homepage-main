...
const topnews = () => {
  return (
    <section className="grid grid-cols-3 mb-[100px] -mt-8 w-[104%] ">
      <div className="col-span-1 flex ">
        ...
        <div className="flex-1 ">
          ...
          <h3 className="font-bold text-[1.2rem] mb-2 ">Reviving Retro PCs</h3>
      ...
      <div className="col-span-1 flex">
        ...
        <div className="flex-1 ">
          ...
          <h3 className="font-bold text-xl mb-2 ">The Growth of Gaming</h3>
          <p className="text-[1.05rem] w-[240px]  text-[#5b5b5b] ">
