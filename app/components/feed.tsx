...
const feed = () => {
  return (
    <main className="grid grid-cols-3 grid-rows-2 mt-[60px] ">
      ...
      <div className="row-start-2 mt-10 row-span-1 col-span-1 flex flex-col">
        <p className="text-[1.2rem] text-[#5b5b5b]">
          We dive into the next evolution of the web that claims to put the
          power of the platforms back into the hands of the people. But is it
          really fulfilling its promise?
        </p>
        <div className="w-max text-md font-bold tracking-widest py-2 px-12 mt-11 bg-[#EE604B]">
          READ MORE
        </div>
      </div>
      <div className="col-start-3 col-span-1 row-span-2 p-7 ml-10 h-[573px] bg-[#00011A]">
        <h1 className="text-[#E8A145] text-4xl font-bold mt-2">New</h1>
